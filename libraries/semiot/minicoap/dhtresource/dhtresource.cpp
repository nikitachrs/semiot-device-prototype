...
DHTResource::DHTResource(const char *tickName, MiniCoAP* coapServer):CoAPResource(coapServer)
{
    EEPROM.begin(5);
    long value;
...
int DHTResource::putMethod(const coap_packet_t *inpkt, coap_packet_t *outpkt)
{
    // FIXME: magic number:
